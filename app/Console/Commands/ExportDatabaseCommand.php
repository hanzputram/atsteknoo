...
class ExportDatabaseCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'db:export-sql {--filename= : Custom filename for the export}';
    ...
    public function handle()
    {
        ...
        $filename = $this->option('filename') ?: "database_dump_{$timestamp}.sql";
        ...
        $sqlContent = "-- ========================================================\n";
        $sqlContent .= "-- PT. ANUGERAH TAMA SEJATI - DATABASE SQL EXPORT DUMP\n";
