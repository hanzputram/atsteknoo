...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->status === 'published' && (!$coverImageId || !$request->category_id)) {
            return back()->withInput()->withErrors(['status' => 'Cover image dan Kategori project wajib diisi sebelum publikasi.']);
        }
