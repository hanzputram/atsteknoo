...
<head>
  ...
  <!-- Schema.org JSON-LD: WebSite with SearchAction for Sitelinks Search Box -->
  <script type="application/ld+json">
  {
    "@@context": "https://schema.org",
    "@type": "WebSite",
  ...
  <!-- Schema.org JSON-LD: FAQPage for Google Rich Snippets & SERP Authority -->
  <script type="application/ld+json">
  {
    "@@context": "https://schema.org",
    "@type": "FAQPage",
  ...
  <style>
    ...
    * {
    ...
    .brand-logo-wrap {
      ...
      border-radius: 14px;
      padding: 6px;
      box-shadow: 0 8px 24px -4px rgba(0, 0, 0, 0.3), inset 0 1px 1px 0 rgba(255, 255, 255, 0.45);
      transition: var(--transition-base);
    }
    ...
    .brand-logo-wrap:hover {
      ...
      box-shadow: 0 12px 28px -2px rgba(0, 0, 0, 0.35), inset 0 1px 2px 0 rgba(255, 255, 255, 0.6);
    }
    ...
    <main class="hero-container" id="heroCardContainer">
        ...
        <section class="hero-main-grid">
          ...
          <div class="hero-left-column">
            ...
            <div class="hero-cta-group">
              <a href="{{ route('products.index') }}" class="btn-cta-white" id="btnProductList">
                <span>
                  <span class="ats-lang-en" data-i18n="hero.btn_products">Product Catalog</span>
          ...
          <div class="hero-showcase-column">
            @php
              ...
              $photos = [
                (object)['is_horizontal' => true, 'path' => 'certificates/cert-schneider.png', 'title' => 'Schneider Electric Partner 2026'],
                (object)['is_horizontal' => false, 'path' => 'certificates/cert-gae.png', 'title' => 'GAE Authorized Distributor'],
                (object)['is_horizontal' => true, 'path' => 'certificates/cert-legrand.jpg', 'title' => 'Legrand Official Retailer Partner'],
              ];
            @endphp
                    ...
                    <div class="swiper-slide {{ $photo->is_horizontal ? 'is-horizontal' : 'is-vertical' }}" data-index="{{ $index }}">
                      <div class="card-inner-frame">
                        <img src="{{ asset($photo->path) }}" 
                             onerror="this.src='{{ url('/public/' . $photo->path) }}';" 
      ...
      <div class="hero-notch-marquee-wrapper" id="notchMarquee" title="Authorized Brands &amp; Official Partners - PT. Anugerah Tama Sejati">
        <div class="marquee-track">
          ...
          <a href="{{ route('brands.show', 'socomec') }}" class="marquee-logo-card" title="Supplier Socomec Surabaya"><img src="{{ asset('logos/Socomec.png') }}" alt="Socomec" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Socomec.png') }}';"></a>
          <a href="{{ route('brands.show', 'autonics') }}" class="marquee-logo-card" title="Supplier Autonics Surabaya"><img src="{{ asset('logos/Autonics.png') }}" alt="Autonics" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Autonics.png') }}';"></a>
          <a href="{{ route('brands.show', 'himel') }}" class="marquee-logo-card" title="Supplier Himel Surabaya"><img src="{{ asset('logos/Himel.png') }}" alt="Himel" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Himel.png') }}';"></a>
          <a href="{{ route('brands.show', 'panasonic') }}" class="marquee-logo-card" title="Supplier Panasonic Surabaya"><img src="{{ asset('logos/Panasonic.png') }}" alt="Panasonic" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Panasonic.png') }}';"></a>
          <a href="{{ route('brands.show', 'philips-lighting') }}" class="marquee-logo-card" title="Supplier Philips Lighting Surabaya"><img src="{{ asset('logos/Philips.png') }}" alt="Philips" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Philips.png') }}';"></a>
          <a href="{{ route('brands.show', 'fluke-corporation') }}" class="marquee-logo-card" title="Supplier Fluke Corporation Surabaya"><img src="{{ asset('logos/Fluke.png') }}" alt="Fluke" width="105" height="26" loading="lazy" onerror="this.src='{{ url('/public/logos/Fluke.png') }}';"></a>
    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-body">
        <div class="contact-channels-list">
          <a href="https://wa.me/6282223332830?text=Hello%20PT%20Anugerah%20Tama%20Sejati,%20I%20would%20like%20to%20inquire%20about%20components%20and%20price%20quotation" target="_blank" class="contact-channel-card">
