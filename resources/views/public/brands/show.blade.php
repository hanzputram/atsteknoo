...
<div class="bg-slate-50 py-10 sm:py-14 border-b border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="flex items-center gap-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-600 mt-1 max-w-2xl">
                        <span class="ats-lang-en">Official catalog and technical specifications for {{ $brand->name }} industrial components.</span>
                        <span class="ats-lang-id">Katalog resmi dan spesifikasi teknis komponen elektrikal industri {{ $brand->name }}.</span>
                    </p>
                </div>
            </div>
            ...
            <div class="w-full mt-4 pt-4 border-t border-slate-200/80 wysiwyg-content prose prose-slate max-w-none text-sm text-slate-700 leading-relaxed">
