...
<div class="bg-slate-50 py-6 border-b border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-2 text-xs text-slate-500" aria-label="Breadcrumb">
            ...
            <span>&rsaquo;</span>
            <a href="{{ route('projects.index') }}" class="hover:text-rose-600 transition">
                <span class="ats-lang-en">Projects Portfolio</span><span class="ats-lang-id">Portofolio Proyek</span>
            </a>
            <span>&rsaquo;</span>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-10">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            @if($project->location)
                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-slate-100 text-slate-700">
                    <span class="ats-lang-en">Location:</span><span class="ats-lang-id">Lokasi:</span> {{ $project->location }}
                </span>
            @endif
            @if($project->completion_year)
                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-slate-100 text-slate-700">
                    <span class="ats-lang-en">Completed:</span><span class="ats-lang-id">Selesai:</span> {{ $project->completion_year }}
                </span>
            @endif
        </div>
    ...
    <div class="p-6 rounded-3xl bg-blue-50/70 border border-blue-100 space-y-2">
        <h3 class="text-xs font-bold uppercase tracking-wider text-blue-900 flex items-center gap-2">
            ...
            <span class="ats-lang-en">Scope of Work</span><span class="ats-lang-id">Ruang Lingkup Pekerjaan</span>
        </h3>
    ...
    <div class="space-y-4">
        <h3 class="text-xl font-bold text-slate-900">
            <span class="ats-lang-en">Project Photo Gallery</span><span class="ats-lang-id">Dokumentasi Foto Proyek</span>
        </h3>
    ...
    <div class="p-8 rounded-3xl bg-slate-900 text-white flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
            <h3 class="text-lg sm:text-xl font-bold">
                <span class="ats-lang-en">Have a Similar Switchboard Project Requirement?</span>
                <span class="ats-lang-id">Memiliki Kebutuhan Perakitan Serupa?</span>
            </h3>
            <p class="text-xs sm:text-sm text-slate-400 mt-1">
                <span class="ats-lang-en">Consult your Single Line Diagram (SLD) and BoQ with our certified engineering team.</span>
                <span class="ats-lang-id">Konsultasikan gambar diagram satu garis (SLD) dan BoQ Anda dengan tim rekayasa kami.</span>
            </p>
        </div>
        <a href="{{ route('contact.index') }}" class="px-6 py-3.5 bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold rounded-xl shrink-0 transition">
            <span class="ats-lang-en">Contact Engineering Team</span>
            <span class="ats-lang-id">Hubungi Tim Engineering</span>
        </a>
    </div>
</div>
@endsection
