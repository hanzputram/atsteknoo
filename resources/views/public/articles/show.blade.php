...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "description": "{{ addslashes($article->meta_description ?: ($article->excerpt ?: $article->title)) }}",
