...
<div id="ats-livechat-container" class="ats-chat-scope">
  ...
  <div id="ats-chat-drawer" class="ats-chat-drawer" aria-hidden="true">
    ...
    <div class="chat-quick-channels-bar">
      ...
      <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sales@atstekno.com&su={{ urlencode('Konsultasi Panel Listrik & Komponen - PT Anugerah Tama Sejati') }}&body={{ urlencode("Halo Tim Sales PT Anugerah Tama Sejati,\n\nSaya ingin berkonsultasi mengenai kebutuhan panel listrik dan komponen industri.\n\nNama:\nPerusahaan:\nKebutuhan:\n\nTerima kasih.") }}" target="_blank" rel="noopener noreferrer" class="channel-chip channel-chip-email" title="Kirim Email via Gmail (sales@atstekno.com)">
