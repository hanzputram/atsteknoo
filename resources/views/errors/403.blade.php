...
@section('title', '403 - Akses Ditolak - PT. Anugerah Tama Sejati')
...
<div class="max-w-3xl mx-auto px-4 py-24 sm:py-32 text-center">
    ...
    <h1 class="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight mb-3">Akses Ditolak (Forbidden)</h1>
    <p class="text-sm sm:text-base text-slate-600 max-w-md mx-auto mb-8">
        Anda tidak memiliki izin untuk mengakses area atau tindakan ini. Silakan periksa kembali akun Anda atau masuk dengan peran yang sesuai.
    </p>
